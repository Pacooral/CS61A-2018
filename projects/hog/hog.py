...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    """def say(score0, score1) :
        if who :
            if abs(score1-previous_score)>previous_high & abs(score1-previous_score)>1 :
                print(abs(score1-previous_score),"points! That's the biggest gain yet for Player1")
                return announce_highest(1,abs(score1-previous_score),score1)
            elif abs(score1-previous_score)>previous_high & abs(score1-previous_score)== 1:
                print("1 point! That's the biggest gain yet for Player1") 
                return announce_highest(1,1,score1)
            else :
                return announce_highest(1,previous_high,score1)
        else :
            if abs(score0-previous_score)>previous_high & abs(score0-previous_score)>1 :
                print(abs(score0-previous_score),"points! That's the biggest gain yet for Player0")
                return announce_highest(0,abs(score0-previous_score),score0)
            elif abs(score0-previous_score)>previous_high & abs(score0-previous_score)== 1:
                print("1 point! That's the biggest gain yet for Player0") 
                return announce_highest(0,1,score0)
            else :
...
def make_averaged(fn, num_samples=1000):
    ...
    def newfunc(*args):
        i,count1=0,0
        while i<num_samples:
            count1,i= count1+fn(*args),i+1
        return count1/num_samples
    return newfunc
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    max_score=0
    while i<=10 :
        q=make_averaged(roll_dice,num_samples)
        q1=q(i,dice)
        if q1 > max_score :
            max_score=q1
            max1num = i
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if score<opponent_score & is_swap(score,opponent_score) :
        return 0
